...
**Mitigation for existing installs:** upgrade to 1.4.9 / 1.5.0; re-encrypt files whose peppers were stored by an earlier version to re-seal them under the v2 wrap; only use a remote-pepper server you trust.
