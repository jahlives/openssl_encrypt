...
def load_keystore_with_debug(keystore_path, master_password):
    ...
    if method.endswith("aes-256-gcm"):
        ...
        argon2_params = params.get(
            "argon2_params", {"time_cost": 8, "memory_cost": 262144, "parallelism": 4}  # 256 MB
        )
        ...
        for name, value in test_values:
            ...
            try:
                ...
                print(
                    f"Parsed as valid JSON - contains {len(json_data)} keys: {list(json_data.keys())}"
                )
            except Exception as e:
