...
def create_and_patch_keystore():
    ...
    class PatchedPQCKeystore(PQCKeystore):
        ...
        def save_keystore(self, master_password: str = None) -> bool:
            ...
            try:
                # Prepare the data
                self.keystore_data["last_modified"] = "2025-05-02T12:00:00.000000"  # Fixed for reproducibility
...
def apply_fix_to_original():
    ...
    pqc_keystore_path = "/home/work/private/git/openssl_encrypt/openssl_encrypt/modules/pqc_keystore.py"
    ...
    try:
        ...
        old_line = "                ciphertext = cipher.encrypt(nonce, plaintext, associated_data=None)"
