...
| **Multi-device recovery** | ❌ None — per-credential secret, non-exportable | ✅ Same 20-byte secret can be loaded onto multiple YubiKey/OnlyKey devices (`--hsm-slot` overridable) |
