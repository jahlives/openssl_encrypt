...
class ImageSteganography(SteganographyBase):
    ...
    def _create_image_from_pixels(self, pixels: List[Tuple[int, ...]], 
    ...
    def _calculate_image_complexity(self, pixels: List[Tuple[int, ...]], 
...
class LSBImageStego(ImageSteganography):
    ...
    def __init__(self, password: Optional[str] = None, security_level: int = 1,
                 bits_per_channel: int = 1, config: Optional[SteganographyConfig] = None):
        """
...
class AdaptiveLSBStego(LSBImageStego):
    ...
    def __init__(self, password: Optional[str] = None, security_level: int = 2,
                 complexity_threshold: float = 10.0, config: Optional[SteganographyConfig] = None):
        """
