...
Validation: the test suite decrypts known-answer vectors generated by the `age`
reference implementation (pyrage/rage) — including one carrying a GREASE stanza
— in addition to independent round-trip and adversarial/integrity tests.
"""
