        ...
        try:
            ...
            if kem_ciphertext_size == 0:
                ...
                if self.algorithm_name in hqc_sizes:
                    ...
                    logger.debug(f"Using hardcoded ciphertext size for {self.algorithm_name}: {kem_ciphertext_size}")
                else:
                    raise ValueError(f"Cannot determine ciphertext size for algorithm {self.algorithm_name}")
