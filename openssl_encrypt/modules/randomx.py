...
def randomx_kdf(password: bytes, salt: bytes, rounds: int = 1, 
                mode: str = "light", height: int = 1, hash_len: int = 32) -> bytes:
    """
    ...
    logger.info(f"RandomX KDF: {rounds} rounds in {mode} mode "
...
def verify_randomx_kdf(password: bytes, salt: bytes, expected_hash: bytes,
                       rounds: int = 1, mode: str = "light", height: int = 1) -> bool:
    """
