...
DEPRECATED_ALGORITHMS: Dict[
    ...
    # All previously deprecated algorithms (camellia, aes-ocb3, kyber*, whirlpool, pbkdf2)
    # have been fully removed in v1.5.0. This dict is kept empty for future deprecations.
}
