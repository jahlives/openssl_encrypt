...
class PQCKeystore:
    ...
    def add_key(self, algorithm: str, public_key: bytes, private_key: bytes, 
                key_password: str = None, use_master_password: bool = True,
        ...
        key_entry = {
            ...
            "purpose": purposes,
            "metadata": {
                "description": description or f"{algorithm} key",
                "tags": tags or []
            },
        ...
        if use_master_password:
            ...
            encrypted_data = self._encrypt_with_derived_key(
                private_key, 
                self.master_key,
                KeystoreProtectionMethod(protection_params["method"])
            )
    ...
    def list_keys(self) -> List[Dict]:
        ...
        for key in self.keystore_data["keys"]:
            ...
            key_info = {
                ...
                "protection": "master_password" if key.get("use_master_password", False) else "key_password"
            }
    ...
    def rotate_key(self, key_id: str, new_algorithm: str = None, 
                  new_key_password: str = None, new_use_master: bool = None) -> str:
        """
    ...
    def import_legacy_key(self, keyfile_path: str, key_password: str = None, 
                         use_master_password: bool = True) -> str:
        """
    ...
    def export_key(self, key_id: str, output_path: str, key_password: str = None, 
                  export_format: str = "modern") -> bool:
        """
    ...
    def change_key_password(self, key_id: str, old_password: str, new_password: str) -> bool:
        ...
        if key_entry.get("use_master_password", False):
            raise ValidationError("This key uses the master password and does not have its own password")
    ...
    def _encrypt_private_key(self, private_key: bytes, password: str, 
                            protection_method: KeystoreProtectionMethod) -> Dict:
        """
    ...
    def _encrypt_with_derived_key(self, data: bytes, derived_key: bytes, 
                                 protection_method: KeystoreProtectionMethod) -> Dict:
        """
