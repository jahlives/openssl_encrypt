...
def _add_hash_kdf_arguments(subparser):
    ...
    duplicating ~300 lines of argument definitions.
    """
    # Hash options
...
def create_subparser_main():
    ...
    recover_parser = subparsers.add_parser(
        "recover",
        help="Decrypt a file using a recovery credential (code/passphrase)",
        formatter_class=argparse.RawTextHelpFormatter,
    )
    ...
    add_recovery_parser = subparsers.add_parser(
        "add-recovery",
        help="Add a recovery slot (code/passphrase) to an envelope file",
        formatter_class=argparse.RawTextHelpFormatter,
    )
