                    ...
                    if pqc_private_key_present:
                        ...
                        if (
                            ...
                            if (
                                ...
                                # gitlab#131 F18: the legacy weak 10k-PBKDF2
                                # pqc_dual_encrypt_verify hash is no longer trusted
                                # (the file password is authenticated by the
                                # dual-encryption AES-GCM tag). Do NOT propagate it
                                # into normalized/rewritten metadata, so a
                                # re-processed file drops the brute-forceable hash
