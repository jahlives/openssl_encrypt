...
@add_timing_jitter
def multi_hash_password(password, salt, hash_config, quiet=False, progress=False):
    """
...
def generate_key(
    ...
    if has_hash_iterations:
        ...
        password = multi_hash_password(password, salt, hash_config, quiet, progress=progress)
