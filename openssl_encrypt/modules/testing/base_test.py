    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.exception:
            result['exception'] = {
                ...
                'traceback': traceback.format_exception(type(self.exception), 
                                                       self.exception, 
...
class BaseSecurityTest(ABC):
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        error_count = sum(1 for r in self.results if r.level in [TestResultLevel.ERROR, TestResultLevel.CRITICAL])
