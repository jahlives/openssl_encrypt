...
class PQCipher:
    ...
    def _derive_symmetric_key(
        ...
        are: AES-GCM/-GCM-SIV/-SIV, ChaCha20/XChaCha20-Poly1305, and
        Threefish-512/-1024 via CTR+Poly1305). Wiring a non-authenticated
        data cipher into the PQC path would silently void the transcript
        binding.
