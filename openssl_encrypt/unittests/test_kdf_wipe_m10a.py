...
2. Minimal-copy + effective-wipe design:
   - cryptography backends (PBKDF2/Scrypt/HKDF), Balloon and RandomX accept a
...
def _backends():
    b = {
        ...
        "pbkdf2": (K.PBKDF2(), K.PBKDF2Params(iterations=1000)),
...
class TestKdfWipeDesign(unittest.TestCase):
    ...
    def test_copyfree_backends_do_not_wipe(self):
        ...
        for name in ("pbkdf2", "scrypt", "hkdf", "balloon"):
