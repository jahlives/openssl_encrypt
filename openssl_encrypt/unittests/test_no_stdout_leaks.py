...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 8452, "print_file_info JSON output"),
    # crypt_core.py — protected DO NOT CHANGE block
    ("crypt_core.py", 10830, "PQC key decryption status (protected)"),
    ("crypt_core.py", 10837, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 10843, "PQC key decryption error (protected)"),
