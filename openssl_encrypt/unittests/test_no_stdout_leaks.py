...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 8318, "print_file_info JSON output"),
    # crypt_core.py — protected DO NOT CHANGE block
    ("crypt_core.py", 10668, "PQC key decryption status (protected)"),
    ("crypt_core.py", 10675, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 10681, "PQC key decryption error (protected)"),
