...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 8635, "print_file_info JSON output"),
    # crypt_core.py — protected DO NOT CHANGE block
    ("crypt_core.py", 11014, "PQC key decryption status (protected)"),
    ("crypt_core.py", 11021, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 11027, "PQC key decryption error (protected)"),
