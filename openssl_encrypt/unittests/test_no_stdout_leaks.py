...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 8386, "print_file_info JSON output"),
    # crypt_core.py — protected DO NOT CHANGE block
    ("crypt_core.py", 10749, "PQC key decryption status (protected)"),
    ("crypt_core.py", 10756, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 10762, "PQC key decryption error (protected)"),
