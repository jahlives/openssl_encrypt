...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 10039, "PQC key decryption status (protected)"),
    ("crypt_core.py", 10046, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 10052, "PQC key decryption error (protected)"),
