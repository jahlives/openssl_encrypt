...
STDOUT_WHITELIST = [
    ...
    ("crypt_core.py", 8690, "print_file_info JSON output"),
    # crypt_core.py — protected DO NOT CHANGE block
    ("crypt_core.py", 11071, "PQC key decryption status (protected)"),
    ("crypt_core.py", 11078, "PQC key decryption failure (protected)"),
    ("crypt_core.py", 11084, "PQC key decryption error (protected)"),
