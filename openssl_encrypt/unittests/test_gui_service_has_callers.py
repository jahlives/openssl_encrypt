...
KNOWN_UNWIRED = [
    # gitlab#192: steganography is being removed from this GUI, so its
    # service methods are dead surface pending that work rather than
    # something to wire up.
    ("encryptWithSteganography", None, "gitlab#192: steganography GUI removal"),
    ("encryptTextWithSteganography", None, "gitlab#192: steganography GUI removal"),
    ("decryptFromSteganography", None, "gitlab#192: steganography GUI removal"),
    ...
    # gitlab#198: the Encrypt tab controls the changelog describes were never
    # built. Listed per-parameter so wiring one at a time shrinks this list.
    ("encryptTextWithProgress", "pqcKeyfile", "gitlab#198: Encrypt tab control never built"),
    ("encryptTextWithProgress", "useXorComposition", "gitlab#198: Encrypt tab control never built"),
    ("encryptTextWithProgress", "parallelKdf", "gitlab#198: Encrypt tab control never built"),
    ("encryptTextWithProgress", "kdfWorkers", "gitlab#198: Encrypt tab control never built"),
    ("encryptTextWithProgress", "independentXor", "gitlab#198: Encrypt tab control never built"),
    ...
    ("verifySignature", "identityStore", "gitlab#198: --identity-store has no GUI control"),
...
class TestGuiServiceHasCallers(unittest.TestCase):
    def test_the_extractor_sees_the_service(self):
        ...
        for expected in ("encryptTextWithProgress", "decryptTextWithProgress", "verifySignature"):
