    ...
    def test_concurrent_create_of_component_is_tolerated(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            def racing_mkdir(self, *args, **kwargs):
                # Simulate a concurrent creator winning the race for the first
                # (shallowest) component, then behave normally.
                calls["n"] += 1
                if calls["n"] == 1:
            ...
            # Despite the simulated race the tree exists and the final dir is 0o700.
