...
KNOWN_BROKEN = [
    # The pepper (gitlab#193) and integrity (gitlab#194) CLI surfaces now exist
    # (`plugin pepper ...` / `plugin integrity ...`), so those GUI call sites
    # parse against the real tree and their KNOWN_BROKEN entries were removed --
    # the stale-entry test would fail if they were left here.
]
