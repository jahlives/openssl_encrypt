...
class TestIntegrityHashStorageAndRetrieval(unittest.TestCase):
    ...
    def test_hash_stored_during_encryption(self, mock_plugin_class, mock_config_class):
        ...
        self.assertEqual(
            self.mock_storage.hashes["static_file_id_abc123"], "static_hash_def456"
        )
...
class TestIntegrityEdgeCases(unittest.TestCase):
    ...
    def test_metadata_hash_different_for_different_data(self):
        ...
        self.assertNotEqual(
            hash1, hash2, msg="Different metadata should have different hashes"
        )
    ...
    def test_file_id_is_64_char_hex(self):
        ...
        self.assertEqual(
            len(file_id), 64, msg="File ID should be 64 characters (SHA-256)"
        )
        self.assertTrue(
    ...
    def test_metadata_hash_is_64_char_hex(self):
        ...
        self.assertEqual(
            len(metadata_hash), 64, msg="Hash should be 64 characters (SHA-256)"
        )
        self.assertTrue(
