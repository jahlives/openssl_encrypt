...
class _BatchOperationsTabState extends State<BatchOperationsTab> {
  ...
  /// (Same guard as the 1.4.x Decrypt tab's _dedupeByName.)
          ...
          children: [
            ...
            if (_ownIdentities.isEmpty) ...[
              ...
              if (_decryptionIdentity != null && _decryptionIdentity!.isNotEmpty) ...[
                ...
                // whose value IS sent to the CLI -- could never be shown. Same
                // guard set as the 1.4.x fix: skip clears and disables the
                // signer dropdown, nothing is editable mid-run, and the red
                // banner appears only when skipping is actually armed.
                const SizedBox(height: 12),
                CheckboxListTile(
                    ...
                    RadioGroup<String>(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          // The skip choice must not survive an operation
                          // change.
                          _verifyFrom = null;
                          _skipVerification = false;
                        });
