...
/// Hash-chain and KDF-chain configuration panels.
///
/// Extracted from the Encrypt tab (gitlab#155) so the Batch Operations tab can
/// present the identical controls. Duplicating them would guarantee the two
/// tabs drift, which is exactly the defect this change fixes: batching silently
/// used CLI defaults while the Encrypt tab used the user's configuration, with
/// nothing in the UI to show the difference.
///
/// The config maps are mutated in place. Dart maps are references, so the
/// owning tab reads the user's choices at encrypt time without further
/// plumbing.
        ...
        child: Column(
          ...
          children: [
            ...
            if (enabled) ...[
              ...
              _buildKDFSlider('Rounds', config['rounds'] ?? 10, 1, 1000000, (v) =>
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (enabled) ...[
              const SizedBox(height: 8),
              _buildKDFSlider('Rounds', config['rounds'] ?? 1, 1, 1000000, (v) =>
        ...
        child: Column(
          ...
          children: [
            ...
            if (enabled) ...[
              ...
              _buildKDFSlider('Rounds', config['rounds'] ?? 2, 1, 1000000, (v) =>
