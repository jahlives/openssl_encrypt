...
// Regression tests for GitLab #137 / GitHub #55 (ported to 1.5.x via
// gitlab#216): the Decrypt tab's asymmetric-decryption fields
// (_decryptionIdentity / _verifyFrom / _skipVerification, mapped to
// --with-key / --verify-from / --no-verify) used to be declared and passed
// to CLIService but were never settable from any widget. These tests assert
// the controls now exist.
//
