...
__version__ = "0.7.3"
__git_commit__ = "3afb728e02855fe721983ac158b5de863634a86e"
...
VERSION_HISTORY = {
    ...
    "0.7.3": "Added new metadata structure in a backward-compatible way. Now allows user defined data encryption when using PQC. Passing all tests and updates docs"
}
