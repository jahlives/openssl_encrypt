...
(This file is kept on both maintenance lines. The gitlab#148 residuals below
apply to 1.5.x exactly as they do to 1.4.x, since the same writer landed on
both; the gitlab#192 section is 1.5.x-specific.)
