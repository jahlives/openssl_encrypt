...
def main():
    ...
    try:
        ...
        print("\nSummary:")
        print("For AES-GCM, the associated_data value must match EXACTLY between encryption and decryption.")
        print("In the test, we encrypted with associated_data=None, and it successfully decrypted with associated_data=None.")
