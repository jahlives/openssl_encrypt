#!/usr/bin/env python3
"""
Test ChaCha20-Poly1305 CLI-Mobile compatibility
"""
...
def test_chacha20_cli_decryption():
    """Test decrypting CLI ChaCha20-Poly1305 file with mobile crypto"""
    print("🧪 Testing ChaCha20-Poly1305 CLI-Mobile Decryption")
    print("=" * 50)
    
    # Read CLI ChaCha20-Poly1305 test file
    test_file = "/home/work/private/git/openssl_encrypt/openssl_encrypt/unittests/testfiles/v5/test1_chacha20-poly1305.txt"
    password = "1234"
    ...
    if result.get('success'):
        ...
        if decrypted.strip() == "Hello World":
            print("✅ SUCCESS: ChaCha20-Poly1305 CLI-Mobile compatibility works!")
            return True
        else:
...
def test_chacha20_mobile_encryption():
    """Test mobile ChaCha20-Poly1305 encryption"""
    print("\n🧪 Testing Mobile ChaCha20-Poly1305 Encryption")
    print("=" * 50)
    
    crypto = MobileCryptoCore()
    test_data = "Hello Mobile ChaCha20!"
    password = "testpass123"
    
    # Test encryption
    result = crypto.encrypt_data(test_data.encode(), password, "chacha20-poly1305")
    ...
    if result.get('success'):
        ...
        if decrypt_result.get('success'):
            ...
            if decrypted == test_data:
                print("✅ SUCCESS: Mobile ChaCha20-Poly1305 round-trip works!")
                return True
            else:
...
def main():
    """Run all ChaCha20-Poly1305 tests"""
    print("🎯 ChaCha20-Poly1305 CLI-Mobile Compatibility Testing")
    print("=" * 60)
    
    success_count = 0
    total_tests = 2
    
    # Test 1: CLI ChaCha20-Poly1305 decryption
    if test_chacha20_cli_decryption():
        success_count += 1
    
    # Test 2: Mobile ChaCha20-Poly1305 encryption/decryption
    if test_chacha20_mobile_encryption():
        success_count += 1
    ...
    if success_count == total_tests:
        print("🎉 ALL TESTS PASSED - ChaCha20-Poly1305 is working!")
        return True
    else:
