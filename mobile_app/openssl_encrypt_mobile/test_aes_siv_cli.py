#!/usr/bin/env python3
"""
Test AES-SIV CLI-Mobile compatibility
"""
...
def test_aes_siv_cli_decryption():
    """Test decrypting CLI AES-SIV file with mobile crypto"""
    print("🧪 Testing AES-SIV CLI-Mobile Decryption")
    print("=" * 50)
    
    # Read CLI AES-SIV test file
    test_file = "/home/work/private/git/openssl_encrypt/openssl_encrypt/unittests/testfiles/v5/test1_aes-siv.txt"
    password = "1234"
    ...
    if result.get('success'):
        ...
        if decrypted.strip() == "Hello World":
            print("✅ SUCCESS: AES-SIV CLI-Mobile compatibility works!")
            return True
        else:
...
def test_aes_siv_mobile_encryption():
    """Test mobile AES-SIV encryption"""
    print("\n🧪 Testing Mobile AES-SIV Encryption")
    print("=" * 50)
    
    crypto = MobileCryptoCore()
    test_data = "Hello Mobile AES-SIV!"
    password = "testpass123"
    
    # Test encryption
    result = crypto.encrypt_data(test_data.encode(), password, "aes-siv")
    ...
    if result.get('success'):
        ...
        if decrypt_result.get('success'):
            ...
            if decrypted == test_data:
                print("✅ SUCCESS: Mobile AES-SIV round-trip works!")
                return True
            else:
...
def main():
    ...
    print("🎯 AES-SIV CLI-Mobile Compatibility Testing")
    print("=" * 60)
    
    success_count = 0
    total_tests = 2
    
    # Test 1: CLI AES-SIV decryption
    if test_aes_siv_cli_decryption():
        success_count += 1
    
    # Test 2: Mobile AES-SIV encryption/decryption
    if test_aes_siv_mobile_encryption():
        success_count += 1
    ...
    if success_count == total_tests:
        print("🎉 ALL TESTS PASSED - AES-SIV is working!")
        return True
    else:
