#!/usr/bin/env python3
"""
Analyze CLI ChaCha20-Poly1305 test file structure
"""

import json
import base64

def analyze_chacha20_file():
    """Analyze the CLI ChaCha20-Poly1305 test file"""
    print("🔍 Analyzing CLI ChaCha20-Poly1305 File Structure")
    print("=" * 50)
    ...
    try:
        ...
        print(f"✅ Format version: {metadata.get('format_version')}")
        print(f"✅ Uses same derivation chain as AES-GCM (hash+KDF)")
        ...
        try:
            ...
            print(f"✅ Expected: 12-byte nonce + ciphertext + 16-byte tag for ChaCha20-Poly1305")
