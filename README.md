...
Goal is to simplify file encryption using openssl by using time-consuming methods to derivate the encryption key from provided user password by hash-chaining and `scrypt`
